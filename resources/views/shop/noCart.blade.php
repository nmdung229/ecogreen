    ...
    <div class="card-details">
        <div class="container">
            <div class="row" style="margin-bottom: 200px;">
                <div class="col-md-8">
                    <h4 style="color:green;"><span style="display: block;">{{ $statusOforder }}</span> {{ $thankyou }}</h4>
                </div>
                <div class="col-md-4">
                    <a href="/"><button class="btn btn-success" style="float:right;">Quay về trang chủ</button></a>
                </div>
            </div>
        </div>
