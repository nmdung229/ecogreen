...
@section('content')
    <section class="content-header">
        <h1>
            Danh Sách Brand <a href="{{route('admin.brand.create')}}" class="btn btn-info pull-right"><i class="fa fa-plus"></i> Thêm Brand</a>
        </h1>
    </section>
                            ...
                            @foreach($data as $key => $item)
                                <tr class="item-{{ $item->id }}"> <!-- Thêm Class Cho Dòng -->
                                    ...
                                    <td class="text-center">
                                        ...
                                        {{--                                        <a href="{{route('admin.brand.destroy', ['id'=> $item->id]) }}" class="btn btn-danger" >Xóa</a>--}}
                                    </td>
                                </tr>
                            @endforeach
                        </table>
